...
sudo mkdir /home/ubuntu/hadoop-native
cd /tmp
...
sudo mv hadoop-dist/target/hadoop-2.4.1/lib/native/* /home/ubuntu/hadoop-native

# Install Snappy lib (for Hadoop)
yum install -y snappy
ln -sf /usr/lib64/libsnappy.so.1 /home/ubuntu/hadoop-native/.
